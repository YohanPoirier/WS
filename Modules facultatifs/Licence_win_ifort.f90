...
!	CHARACTER(LEN=Nchar),PARAMETER :: Clef='COMPUTERNAME=ANDREJ-PC             '    ! Maynooth licence 2014
	CHARACTER(LEN=Nchar),PARAMETER :: Clef='COMPUTERNAME=GIORGIO-PC            '    ! Maynooth licence 2015
...
!	
    ...
    WRITE(*,*) ' Seule son utilisation dans ce cadre est autorisee.'
    WRITE(*,*) '-------------------------------------------------------------------------------'
    WRITE(*,*) ' '
!!	Lecture du nom PC
!	rsystem=SYSTEM('set computername > key')
!    OPEN(10,FILE='key')
!    READ(10,*) NomPC
!    CLOSE(10)
...
!	Lecture de la date
	...
	DateCourante(3)=ichar(Nomcourant(4:4))-48+10*(ichar(Nomcourant(3:3))-48)+100*(ichar(Nomcourant(2:2))-48)+1000*(ichar(Nomcourant(1:1))-48)
